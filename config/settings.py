...
MIDDLEWARE = [
    ...
    'django.contrib.sessions.middleware.SessionMiddleware',  # ✅ Required for session-based anonymous IDs
...
REST_FRAMEWORK = {
    ...
    # ✅ Disable throttling for testing (re-enable for production!)
...
MAX_FILES_PER_USER = int(os.getenv('MAX_FILES_PER_USER', 5))
